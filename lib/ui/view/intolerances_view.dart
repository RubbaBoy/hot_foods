...
import 'package:hot_foods/scoped_model/intolerances_model.dart';
import 'package:hot_foods/ui/view/base_view.dart';
import 'package:hot_foods/utils/color_utils.dart';

class IntolerancesView extends StatelessWidget {
  const IntolerancesView({super.key});

  @override
  Widget build(BuildContext context) {
    return BaseView<IntolerancesModel>(
              ...
              child: Column(
                children: [
                  TextField(
                    ...
                    onSubmitted: (_) => model.addIntolerance(),
                    decoration: InputDecoration(
                        hintText: 'Add an intolerance',
                        contentPadding:
                        ...
                        suffixIcon: Padding(
                          ...
                          child: IconButton(
                            ...
                            onPressed: () => model.addIntolerance(),
                          ),
                        )),
                  ),
                  SizedBox(height: 20),
                              ...
                              .map((allergen) => Padding(
                                  ...
                                  child: createAllergen(
                                      ...
                                      icon: InkWell(
                                        ...
                                        onTap: () => model.removeIntolerance(allergen),
                                      ))))
                              .toList(),
                        ),
                  )
